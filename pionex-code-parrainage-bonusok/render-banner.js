...
const output = path.join(root, "assets", "pionex-bonusok-french-code-parrainage-banner.png");
const workspace = path.join(process.cwd(), "..", "..", "..");
const workOutput = path.join(workspace, "exchanges", "Pionex", "outputs", "pionex-bonusok-french-code-parrainage-banner.png");
const qaOutput = path.join(workspace, "exchanges", "Pionex", "work", "pionex-french-vercel", "banner-layout-qa.json");
fs.mkdirSync(path.dirname(workOutput), { recursive: true });
