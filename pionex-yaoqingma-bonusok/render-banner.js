...
const output = path.join(root, "assets", "pionex-bonusok-mandarin-yaoqingma-banner.png");
const workspace = path.join(process.cwd(), "..", "..", "..");
const workOutput = path.join(workspace, "exchanges", "Pionex", "outputs", "pionex-bonusok-mandarin-yaoqingma-banner.png");
const qaOutput = path.join(workspace, "exchanges", "Pionex", "work", "pionex-mandarin-vercel", "banner-layout-qa.json");
