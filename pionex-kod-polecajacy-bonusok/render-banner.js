...
const output = path.join(root, "assets", "pionex-bonusok-polish-kod-polecajacy-banner.png");
const workspace = path.join(process.cwd(), "..", "..", "..");
const workOutput = path.join(workspace, "exchanges", "Pionex", "outputs", "pionex-bonusok-polish-kod-polecajacy-banner.png");
const qaOutput = path.join(workspace, "exchanges", "Pionex", "work", "pionex-polish-vercel", "banner-layout-qa.json");
