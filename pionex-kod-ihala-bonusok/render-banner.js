...
const output = path.join(root, "assets", "pionex-bonusok-arabic-kod-ihala-banner.png");
const workOutput = path.join(workspace, "exchanges", "Pionex", "outputs", "pionex-bonusok-arabic-kod-ihala-banner.png");
const qaOutput = path.join(workspace, "exchanges", "Pionex", "work", "pionex-arabic-vercel", "banner-layout-qa.json");
...
(async () => {
  ...
  const metrics = await page.evaluate(() => {
    ...
    return {
      ...
      qrCard: box(".qr-card"),
      qrBox: box(".qr-box"),
      text: [textBox(".eyebrow"), textBox(".headline"), textBox(".subhead"), textBox(".code-label"), textBox(".code-value"), textBox(".qr-title"), textBox(".qr-subtitle")],
